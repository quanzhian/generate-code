...
<title>${table.entityComment}新增</title>
</head>
<body class="gray-bg">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>${table.entityComment}新增</h5>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm"  action="${r"$"}{ctx}/admin/${table.entityNameFirst}/create" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="${tableField.entityField}" name="${tableField.entityField}" class="form-control" type="text">
